...
void snackBarFeatureNotAvailable(BuildContext context) {
  const snackBar = SnackBar(
    content: Center(child: Text('Feature will be available soon')),
      ...
      title: Center(
        child: Column(
          children: [
            ...
            Text(
              'Are you sure you want to cancel joining this activity?',
              style: TextStyle(
